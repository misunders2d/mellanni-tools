...
def google_search_agent_tool(name="google_search_agent"):
    google_search_agent_tool = AgentTool(
        agent=Agent(
            name=name,
            description="Use this agent to perform Google searches and retrieve information from the web. You **MUST** output the results to the user - the tool itself is not shown in user interaction.",
