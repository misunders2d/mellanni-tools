...
def create_storyline_loop_agent():
    storyline_loop_agent = LoopAgent(
        ...
        sub_agents=[create_storyline_agent(), create_fact_checker(name=prompts.FACT_CHECKER_AGENT)],
        max_iterations=7
    )
...
def create_full_content_loop_agent():
    full_content_loop_agent = LoopAgent(
        ...
        sub_agents=[create_full_content_drafter_agent(), create_fact_checker(name=prompts.FACT_CHECKER_AGENT)],
        max_iterations=7
    )
...
def create_image_prompt_loop_agent():
    image_prompt_loop_agent = LoopAgent(
        ...
        sub_agents=[create_image_prompt_generator_agent(), create_image_prompt_checker(name=prompts.IMAGE_PROMPTS_CHECKER)],
        max_iterations=7
    )
