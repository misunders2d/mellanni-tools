...
table_data = {
    "auxillary_development": {
        ...
        "attribution": "",
        "dashboard": "",
        "dictionary": "A mapping table (dictionary), containing all the necessary ASIN and SKU mapping data for USA. Be careful when joining this table on ASINs, as they contain multiple duplicate values.",
        "dictionary_ca": "A mapping table (dictionary), containing all the necessary ASIN and SKU mapping data for Canada. Be careful when joining this table on ASINs, as they contain multiple duplicate values.",
        "dictionary_eu": "A mapping table (dictionary), containing all the necessary ASIN and SKU mapping data for Europe. Be careful when joining this table on ASINs, as they contain multiple duplicate values.",
        "dictionary_shp": "A mapping table (dictionary), containing all the necessary SKU mapping data for Shopify",
        "dictionary_uk": "A mapping table (dictionary), containing all the necessary ASIN and SKU mapping data for United Kingdom. Be careful when joining this table on ASINs, as they contain multiple duplicate values.",
    ...
    "reports": {
        ...
        "business_report": "One of the main tables showing sales data including Sessions (organic impressions) on an SKU level. Do not use for conversion calculations.",
        "business_report_asin": "One of the main tables showing sales data including Sessions (organic impressions) on an ASIN level. Use for conversion calculations.",
        "date_range_report": "",
        "dictionary": "",
        "dsp_report": "",
        "exchange_rates": "",
